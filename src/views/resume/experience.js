export const experience = [
    { 
        ...
        body: [
            ...
            "Allows system admins to manage data synchronization and update tasks within the Alation Data Catalog to collect/organize various data sources (Teradata, Hadoop, etc…)", 
